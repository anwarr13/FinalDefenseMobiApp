...
Need help? Contact our support team anytime.''',
  ...
  Widget _buildOperatingHours(Map<String, dynamic> hours) {
    if (hours.isEmpty) {
      return const Text('Operating hours not set');
    }
      ...
      child: Column(
        ...
        children: [
          ...
          ...daysOrder.map((day) {
            ...
            if (schedule == null) {
              return _buildDayScheduleRow(day, 'Not set', isNotSet: true);
            }
            ...
            return _buildDayScheduleRow(day, displayText, textColor: textColor);
          }).toList(),
        ],
      ),
    );
  ...
  Widget _buildDayScheduleRow(String day, String schedule, {Color? textColor, bool isNotSet = false}) {
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            schedule,
            style: TextStyle(
              color: isNotSet ? Colors.grey : textColor,
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      ...
                      if (data['operatingHours'] != null) ...[
                        const SizedBox(height: 16),
                        _buildOperatingHours(data['operatingHours'] as Map<String, dynamic>),
                      ],
                      const SizedBox(height: 16),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.end,
                        children: [
                          ElevatedButton.icon(
                            ...
                            label: Text(data['isActive'] == false
                                ? 'Enable Bar'
                                : 'Disable Bar'),
                            style: ElevatedButton.styleFrom(
                            ...
                            onPressed: () => _handleBarStatus(
                                docs[index].id, data['isActive'] == false),
                          ),
                        ],
                      ),
                    ],
